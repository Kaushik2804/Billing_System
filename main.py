...
class Bill_app:
    def __init__(self, root):
        ...
        bg_color = "#17202A"
        title = Label(self.root, text="FAST FOOD CENTRE ", bd=12, relief=GROOVE, bg=bg_color, fg="white",
                      font=("times new roman", 30, "bold")).pack(fill=X)
        # ======variables=======
        self.a1_txtt = IntVar()
        self.a2_txtt = IntVar()
        self.a3_txtt = IntVar()
        ...
        cname_lb1 = Label(F1, text="Customer Name", bg=bg_color, fg="white", font=("times new roman", 18, "bold")).grid(
        ...
        cphn_lbl = Label(F1, text="Phone Number", bg=bg_color, fg="white", font=("times new roman", 18, "bold")).grid(
        ...
        c_bill_txt = Entry(F1, width=15, textvariable=self.search_bill, font=("arial", 15, "bold"), bd=7,
                           relief=SUNKEN).grid(row=0, column=5, padx=5, pady=10)

        bill_btn = Button(F1, text="Search", width=15, command=self.find_bill, bd=7, font="arial 12 bold").grid(row=0,
                                                                                                                column=6,
                                                                                                                padx=7,
                                                                                                                pady=10)
        ...
        a1_txt = Entry(F2, width=15, textvariable=self.a1_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        a2_txt = Entry(F2, width=15, textvariable=self.a2_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=1, column=1, padx=5, pady=10)
        ...
        a3_txt = Entry(F2, width=15, textvariable=self.a3_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        a4_txt = Entry(F2, width=15, textvariable=self.a4_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        a6_txt = Entry(F2, width=15, textvariable=self.a5_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        b1_lbl = Label(F3, text="Fries", font=("times new roman", 16, "bold"), bg=bg_color, fg="#5DADE2").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        b1_txt = Entry(F3, width=15, textvariable=self.b1_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=0, column=1,
                                           padx=10, pady=10)

        b2_lbl = Label(F3, text="Nuggets", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        b2_txt = Entry(F3, width=15, textvariable=self.b2_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=1, column=1, padx=5, pady=10)

        b3_lbl = Label(F3, text="Garlic Bread", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        b3_txt = Entry(F3, width=15, textvariable=self.b3_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        b4_lbl = Label(F3, text="Chi-Popcorn", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        b4_txt = Entry(F3, width=15, textvariable=self.b4_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        b5_lbl = Label(F3, text="Chi-Peri-Peri", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        b5_txt = Entry(F3, width=15, textvariable=self.b5_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)
        ...
        c1_lbl = Label(F4, text="Coke", font=("times new roman", 16, "bold"), bg=bg_color, fg="#5DADE2").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        c1_txt = Entry(F4, width=15, textvariable=self.c1_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        c2_lbl = Label(F4, text="Sprite", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        c2_txt = Entry(F4, width=15, textvariable=self.c2_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=1, column=1, padx=5, pady=10)

        c3_lbl = Label(F4, text="Mazza", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        c3_txt = Entry(F4, width=15, textvariable=self.c3_txtt, font=("times new roman", 15, "bold"), bd=7,
                       relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        c4_lbl = Label(F4, text="7up", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        c4_txt = Entry(F4, width=15, textvariable=self.c4_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        c5_lbl = Label(F4, text="Mirinda", font=("times new roman", 16, "bold"), bg=bg_color,
                       fg="#5DADE2").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        c5_txt = Entry(F4, width=15, textvariable=self.c5_txtt, font=("times new roman", 15, "bold"), bd=7,
        ...
        F5.place(x=1010, y=180, width=520, height=350)
        ...
        m1_txt = Entry(F6, width=18, textvariable=self.a_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                                column=1,
                                                                                                                padx=10,
                                                                                                                pady=1)
        ...
        m2_txt = Entry(F6, width=18, textvariable=self.b_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=1,
                                                                                                                column=1,
                                                                                                                padx=10,
                                                                                                                pady=1)
        ...
        m3_txt = Entry(F6, width=18, textvariable=self.c_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=2,
                                                                                                                column=1,
                                                                                                                padx=10,
                                                                                                                pady=1)

        s1 = Label(F6, text="Mains Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=0,
                                                                                                             column=2,
                                                                                                             padx=20,
                                                                                                             pady=1,
                                                                                                             sticky="w")
        s1_txt = Entry(F6, width=18, textvariable=self.a_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                              column=3,
                                                                                                              padx=10,
                                                                                                              pady=1)

        s2 = Label(F6, text="Sides Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=1,
                                                                                                             column=2,
                                                                                                             padx=20,
                                                                                                             pady=1,
                                                                                                             sticky="w")
        s2_txt = Entry(F6, width=18, textvariable=self.b_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=1,
                                                                                                              column=3,
                                                                                                              padx=10,
                                                                                                              pady=1)
        ...
        s3_txt = Entry(F6, width=18, textvariable=self.c_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=2,
                                                                                                              column=3,
                                                                                                              padx=10,
                                                                                                              pady=1)
        ...
        GBill_btn = Button(btn_F, text="Generate Bill", bg="#5DADE2", fg="white", bd=2, pady=15, width=10,
                           command=self.bill_area,
                           font="arial 15 bold").grid(row=0, column=1, padx=5, pady=5)
        Clear_btn = Button(btn_F, text="Clear", bg="#5DADE2", fg="white", bd=2, pady=15, width=10,
